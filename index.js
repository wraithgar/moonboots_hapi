...
function setDefaults(options, next) {
    if (!options.appPath) {
        if (!options.jsFileName || !options.cssFileName) {
            return next('Cannot default both appPath and js or css file name');
        }
...
exports.register = function (plugin, options, next) {
    ...
    async.forEach(clientApps, function _eachApp(options, cb) {
        setDefaults(options, function _setupApp(err, options) {
